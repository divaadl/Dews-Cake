...
<div class="page-wrapper">
    <div class="container">
        ...
        <h3>Edit Produk Paket</h3>

        <form action="/admin/produk-paket/{{ $paket->paket_id }}/update" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="jenis_paket" required>
                    ...
                    <option value="kotak" {{ $paket->jenis_paket == 'kotak' ? 'selected' : '' }}>
                        Kotak
                    </option>
                    <option value="nampan" {{ $paket->jenis_paket == 'nampan' ? 'selected' : '' }}>
                        Nampan
                    </option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="minimal_budget" id="minimal_budget"
                       value="{{ $paket->minimal_budget }}" required>
            </div>

            <div class="form-group">
                <label>Maksimal Budget</label>
                <input type="text" name="maksimal_budget" id="maksimal_budget"
                       value="{{ $paket->maksimal_budget }}" required>
            </div>

            <div class="form-group">
                <label>Jumlah Maksimal Kue</label>
                <input type="number" name="max_kue" min="1" value="{{ old('max_kue', $paket->max_kue) }}" required>
            </div>
                ...
                <div class="radio-group">
                    <label>
                        <input type="radio" name="status" value="aktif"
                            {{ $paket->status == 'aktif' ? 'checked' : '' }}>
                        Aktif
                    </label>
                    <label>
                        <input type="radio" name="status" value="nonaktif"
                            {{ $paket->status == 'nonaktif' ? 'checked' : '' }}>
                        Nonaktif
                    </label>
                </div>
            </div>
